...
public class PlaybackIconAdapter extends RecyclerView.Adapter<PlaybackIconAdapter.ViewHolder> {
    ...
    private onİtemClickListener mListener;

    public interface onİtemClickListener {
        void onItemClick(int position);
    }
    public void setOnItemClickListener(onİtemClickListener listener){
        mListener=listener;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView iconName;
        ImageView icon;
        public ViewHolder(@NonNull View itemView,onİtemClickListener listener) {
            super(itemView);
